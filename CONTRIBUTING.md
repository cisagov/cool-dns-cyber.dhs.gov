...
issue](https://github.com/cisagov/cool-dns/issues) in this
...
request](https://github.com/cisagov/cool-dns/pulls), you
...
```console
cd cool-dns
pyenv virtualenv <python_version_to_use> cool-dns
pyenv local cool-dns
